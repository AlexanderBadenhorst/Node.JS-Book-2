...
mongoose.connect('mongodb+srv://AlexanderBadenhorst:zIUtYTAUN0KH2jHB@test-cluster.wnxpq.mongodb.net/blog_db', { useNewUrlParser: true });//user password: zIUtYTAUN0KH2jHB
